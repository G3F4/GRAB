...
public:
    ...
    void rotate(int angle); /* Passing positive value will rotate clockwise, negative opposite */
...
protected:
    ...
    /* #TODO use pointer to default window instead of name in string to refer to proper window */
    std::string m_window_ID; /* string storing name of Window which Texture will be rendered to */
    double m_angle; /* angle representing angle of rotation that was applied to texture */
